...
public class lesson_4 {
    private static final String USER_SIGN = "X";
    private static final String USER_SIGN_SECOND = "O";
    private static final String AI_SIGN = "O";
    private static final String NOT_SIGN = "*";
    private static int aiLevel = 0;
    private static final int DIMENSION = 4;
    private static String[][] field = new String[DIMENSION][DIMENSION];
    ...
    private static void userShot(String sign, int i) {
        int x = -1;
        int y = -1;
        do {
            if (i == 0) {
    ...
    private static boolean isCellBusy(int x, int y) {
